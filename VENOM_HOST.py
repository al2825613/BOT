...
# ===== إعدادات يجب تعديلها =====
TOKEN = 'ضع_توكن_البوت_هنا'  # ضع توكن البوت هنا
ADMIN_ID = 123456789   # ضع آيدي المطور هنا
YOUR_USERNAME = '@Hamo_2025'  # يوزر المطور
CHANNEL_USERNAME = '@ZERO_20026' # يوزر القناة
# =============================
...
def ask_to_upload_file(call):
    ...
    if bot_locked:
        bot.send_message(call.message.chat.id, "⚠️ البوت مقفل حالياً. الرجاء التواصل مع المطور @Hamo_2025.")
        return
    ...
    if free_mode or (user_id in user_subscriptions and user_subscriptions[user_id]['expiry'] > datetime.now()):
        ...
        bot.send_message(call.message.chat.id, "⚠️ يجب عليك الاشتراك لاستخدام هذه الميزة. الرجاء التواصل مع المطور @Hamo_2025.")
...
def handle_file(message):
    ...
    if bot_locked:
        bot.reply_to(message, "⚠️ البوت مقفل حالياً. الرجاء التواصل مع المطور @Hamo_2025.")
        return
    ...
    if free_mode or (user_id in user_subscriptions and user_subscriptions[user_id]['expiry'] > datetime.now()):
        ...
        bot.reply_to(message, "⚠️ يجب عليك الاشتراك لاستخدام هذه الميزة. الرجاء التواصل مع المطور @Hamo_2025.")
